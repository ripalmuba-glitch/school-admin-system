<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <form action="{{ route('admin.academicyears.store') }}" method="POST" class="space-y-6 max-w-lg mx-auto">
            @csrf

            <div>
                <label for="year_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Tahun Ajaran</label>
                <input type="text" name="year_name" id="year_name" value="{{ old('year_name') }}" required
