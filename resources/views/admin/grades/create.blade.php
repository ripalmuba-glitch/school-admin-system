<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <form method="GET" action="{{ route('admin.grades.create') }}" class="mb-6 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg border dark:border-gray-600">
        ...
        {{-- PERBAIKAN DI SINI: Menggunakan count($students) alih-alih $students->count() --}}
        @if (count($students) > 0)
            <form action="{{ route('admin.grades.store') }}" method="POST">
                ...
                <div class="max-w-md mb-6">
                    <label for="teacher_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Guru Pemberi Nilai</label>
