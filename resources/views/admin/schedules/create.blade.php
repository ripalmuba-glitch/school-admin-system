<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <form action="{{ route('admin.schedules.store') }}" method="POST" class="space-y-6 max-w-lg mx-auto">
            @csrf
            ...
            <div class="flex justify-end space-x-4 pt-4">
                <a href="{{ route('admin.schedules.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200">
                    Batal
                </a>
