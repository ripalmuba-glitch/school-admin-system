<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <form action="{{ route('admin.students.store') }}" method="POST" class="space-y-6 max-w-2xl mx-auto">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('address') }}</textarea>
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 -mt-4">Akun ini akan otomatis memiliki Role "Siswa".</p>
